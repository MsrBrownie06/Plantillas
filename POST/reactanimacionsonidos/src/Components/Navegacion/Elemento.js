...
export default class Elemento extends Component {
  ...
  state = {
    ...
    estado: false,
    personajes: [
      { nombre: "Albedo", elemento: "Geo", ciudad: "Mondstadt", arma: "Espada", estrellas: 5, imagen: AlbedoImg },
      { nombre: "Aloy", elemento: "Cryo", ciudad: "Horizon Zero Dawn", arma: "Arco", estrellas: 5, imagen: AloyImg },
      { nombre: "Amber", elemento: "Pyro", ciudad: "Mondstadt", arma: "Arco", estrellas: 4, imagen: AmberImg },
      { nombre: "Baizhu", elemento: "Dendro", ciudad: "Liyue", arma: "Desconocido", estrellas: 5, imagen: BaizhuImg },
      { nombre: "Barbara", elemento: "Hydro", ciudad: "Mondstadt", arma: "Catalizador", estrellas: 4, imagen: BarbaraImg },
      { nombre: "Beidou", elemento: "Electro", ciudad: "Liyue", arma: "Mandoble", estrellas: 4, imagen: BeidouImg },
      { nombre: "Bennett", elemento: "Pyro", ciudad: "Mondstadt", arma: "Espada", estrellas: 4, imagen: BennettImg },
      { nombre: "Chongyun", elemento: "Cryo", ciudad: "Liyue", arma: "Mandoble", estrellas: 4, imagen: ChongyunImg },
      { nombre: "Diluc", elemento: "Pyro", ciudad: "Mondstadt", arma: "Mandoble", estrellas: 5, imagen: DilucImg },
      { nombre: "Diona", elemento: "Cryo", ciudad: "Mondstadt", arma: "Arco", estrellas: 4, imagen: DionaImg },
      { nombre: "Eula", elemento: "Cryo", ciudad: "Mondstadt", arma: "Mandoble", estrellas: 5, imagen: EulaImg },
      { nombre: "Fischl", elemento: "Electro", ciudad: "Mondstadt", arma: "Arco", estrellas: 4, imagen: FischlImg },
      { nombre: "Hu Tao", elemento: "Pyro", ciudad: "Liyue", arma: "Lanza", estrellas: 5, imagen: HuTaoImg },
      { nombre: "Jean", elemento: "Anemo", ciudad: "Mondstadt", arma: "Espada", estrellas: 5, imagen: JeanImg },
      { nombre: "Kaedehara Kazuha", elemento: "Anemo", ciudad: "Inazuma", arma: "Espada", estrellas: 5, imagen: KaedeharaKazuhaImg },
      { nombre: "Kaeya", elemento: "Cryo", ciudad: "Mondstadt", arma: "Espada", estrellas: 4, imagen: KaeyaImg },
      { nombre: "Kamisato Ayaka", elemento: "Cryo", ciudad: "Inazuma", arma: "Espada", estrellas: 5, imagen: KamisatoAyakaImg },
      { nombre: "Keqing", elemento: "Electro", ciudad: "Liyue", arma: "Espada", estrellas: 5, imagen: KeqingImg },
      { nombre: "Klee", elemento: "Pyro", ciudad: "Mondstadt", arma: "Catalizador", estrellas: 5, imagen: KleeImg },
      { nombre: "Kujou Sara", elemento: "Electro", ciudad: "Inazuma", arma: "Arco", estrellas: 5, imagen: KujouSaraImg },
      { nombre: "Lisa", elemento: "Electro", ciudad: "Mondstadt", arma: "Catalizador", estrellas: 4, imagen: LisaImg },
      { nombre: "Mona", elemento: "Hydro", ciudad: "Mondstadt", arma: "Catalizador", estrellas: 5, imagen: MonaImg },
      { nombre: "Ningguang", elemento: "Geo", ciudad: "Liyue", arma: "Catalizador", estrellas: 4, imagen: NingguangImg },
      { nombre: "Noelle", elemento: "Geo", ciudad: "Mondstadt", arma: "Mandoble", estrellas: 4, imagen: NoelleImg },
      { nombre: "Qiqi", elemento: "Cryo", ciudad: "Liyue", arma: "Espada", estrellas: 5, imagen: QiqiImg },
      { nombre: "Raiden Shogun", elemento: "Electro", ciudad: "Inazuma", arma: "Lanza", estrellas: 5, imagen: RaidenShogunImg },
      { nombre: "Razor", elemento: "Electro", ciudad: "Mondstadt", arma: "Mandoble", estrellas: 4, imagen: RazorImg },
      { nombre: "Rosaria", elemento: "Cryo", ciudad: "Mondstadt", arma: "Lanza", estrellas: 4, imagen: RosariaImg },
      { nombre: "Sacarosa", elemento: "Anemo", ciudad: "Mondstadt", arma: "Catalizador", estrellas: 4, imagen: SacarosaImg },
      { nombre: "Sangonomiya Kokomi", elemento: "Hydro", ciudad: "Inazuma", arma: "Catalizador", estrellas: 5, imagen: SangonomiyaKokomiImg },
      { nombre: "Sayu", elemento: "Anemo", ciudad: "Inazuma", arma: "Mandoble", estrellas: 4, imagen: SayuImg },
      { nombre: "Tartaglia", elemento: "Hydro", ciudad: "Snezhnaya", arma: "Arco", estrellas: 5, imagen: TartagliaImg },
      { nombre: "Thoma", elemento: "Pyro", ciudad: "Inazuma", arma: "Lanza", estrellas: 4, imagen: ThomaImg },
      { nombre: "Venti", elemento: "Anemo", ciudad: "Mondstadt", arma: "Arco", estrellas: 5, imagen: VentiImg },
      { nombre: "Xiangling", elemento: "Pyro", ciudad: "Liyue", arma: "Lanza", estrellas: 4, imagen: XianglingImg },
      { nombre: "Xiao", elemento: "Anemo", ciudad: "Liyue", arma: "Lanza", estrellas: 5, imagen: XiaoImg },
      { nombre: "Xingqiu", elemento: "Hydro", ciudad: "Liyue", arma: "Espada", estrellas: 4, imagen: XingqiuImg },
      { nombre: "Xinyan", elemento: "Pyro", ciudad: "Liyue", arma: "Mandoble", estrellas: 4, imagen: XinyanImg },
      { nombre: "Yanfei", elemento: "Pyro", ciudad: "Liyue", arma: "Catalizador", estrellas: 4, imagen: YanfeiImg },
      { nombre: "Yoimiya", elemento: "Pyro", ciudad: "Inazuma", arma: "Arco", estrellas: 5, imagen: YoimiyaImg },
      { nombre: "Zhongli", elemento: "Geo", ciudad: "Liyue", arma: "Lanza", estrellas: 5, imagen: ZhongliImg },
    ]
  }
  ...
  seleccionarPersonajes() {
    ...
    for (let i = 0; i < this.state.personajes.length; i++) {
      if (this.state.personajes[i].elemento.toLowerCase() === this.props.vision) {
